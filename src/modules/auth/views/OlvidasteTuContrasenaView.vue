<template>
    <div style="background-image: url('/assets/img/backgrounds//page-bg.png');position:absolute;bottom:0;width:100%;height:100%; padding-top: 40px;">
        <div class="m-auto"
            ...
            <div class="page-logo m-0 w-100 align-items-center justify-content-center rounded-top border-bottom-left-radius-0 border-bottom-right-radius-0"
                style="position:relative;background-image:none;background:#fff;-webkit-box-shadow: none;padding-top:9px;height:170px;">
            ...
            <div class="card border-top-left-radius-0 border-top-right-radius-0 rounded-bottom"
                ...
                <form novalidate
                    ...
                    <button type="submit"
                            class="btn btn-primary float-right">Confirmar</button>
                </form>
